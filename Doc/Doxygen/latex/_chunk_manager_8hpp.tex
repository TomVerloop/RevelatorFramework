...
\begin{DoxyCompactList}\small\item\em This class contains a reference to the first chunk. and the one the camera hovers above. \end{DoxyCompactList}\end{DoxyCompactItemize}
