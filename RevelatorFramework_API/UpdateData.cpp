...
UpdateData::UpdateData(sf::RenderWindow * window) : MousePosition{
	sf::Mouse::getPosition()}
{
	Window = window;
	CameraPosition = window->getDefaultView().getCenter();
...
void UpdateData::MoveCamera(sf::Vector2f direction)
{
...
void UpdateData::SetCameraPosition(sf::Vector2f Position)
{
...
sf::Vector2f UpdateData::getMousePosition()
{
